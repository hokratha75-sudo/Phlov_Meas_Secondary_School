      ...
      >
        <div className="container mx-auto px-4 md:px-8 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-3">
            <img src="/emblem.png" alt="School Logo" className="h-12 w-12 md:h-16 md:w-16 object-contain" />
        ...
        <div className="container mx-auto px-4 md:px-8 grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center gap-3 mb-6">
              <img src="/emblem.png" alt="School Logo" className="h-14 w-14 object-contain brightness-0 invert" />
              <div className="flex flex-col">
