    ...
    <div className="space-y-6">
      <div className="bg-white border rounded-xl p-6 shadow-sm">
        <div className="flex items-start gap-3">
          ...
          <div>
            <h2 className="text-xl font-bold text-gray-800">Bac II Standards</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {areas.map(area => (
          <div key={area.titleEn} className="bg-white border rounded-xl p-5 shadow-sm">
            <p className="font-semibold text-gray-800">{area.titleEn}</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="bg-white border rounded-xl p-5 shadow-sm">
          <p className="font-semibold text-gray-800 mb-2">Useful options</p>
        ...
        <div className="bg-white border rounded-xl p-5 shadow-sm">
          <p className="font-semibold text-gray-800 mb-2">Suggested data</p>
